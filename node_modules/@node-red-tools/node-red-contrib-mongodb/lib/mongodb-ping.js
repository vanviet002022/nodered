...
module.exports = function register(RED) {
    RED.nodes.registerType('mongodb-ping', function mongodbPing(props) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        setValue(RED, msg, this, this.propertyType, this.property, result);
                        send(msg);
                        done();
                        return [7 /*endfinally*/];
